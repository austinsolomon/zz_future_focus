...
(1,"Origins — What 1940s computers did","In the 1940s the first electronic computers (like ENIAC) were essentially giant, fast calculators built to crunch numbers — e.g. artillery tables — not to reason.","Number-crunching calculators","Early machines executed fixed arithmetic at speed; they did exactly what they were wired to do, nothing more.",["bigpicture","history"],1946),
(1,"Origins — What 1950s–60s computers did","Through the 1950s and 60s computers mostly automated paperwork — payroll, census, inventory — by following fixed instructions over batches of data.","Batch data processing","Business 'data processing' dominated; the computer was a meticulous clerk, not a learner.",["bigpicture","history"],1955),
(2,"Origins — What early machines couldn't do","Early computers could prove theorems and play chess, yet failed at what a toddler does effortlessly — recognising a face, understanding speech.","Machines lacked perception","Perception and language resist explicit rules; this gap is what eventually pushed the field toward learning from data.",["bigpicture","why"],1965),
(2,"Origins — Why hand-built rules stalled","Encoding intelligence as huge sets of hand-written if-then rules proved fragile: rules contradicted each other, missed edge cases, and were impossible to maintain.","Brittle rule-based systems","This 'knowledge bottleneck' of rule-based AI motivated systems that infer their own rules from examples.",["bigpicture","why"],1966),
(1,"Origins — Program vs. learned model","The distinction behind modern AI: a traditional program is a fixed recipe written by a person; a model is a recipe learned from data.","Program vs learned model","Software 1.0 — humans write the rules; software 2.0 — data shapes the model's parameters.",["bigpicture","why"],1960),
(2,"Origins — Why the field turned to learning","Faced with perception problems and brittle rules, researchers bet that machines should learn patterns from examples rather than be told every rule.","Bet on learning over rules","This bet — data over hand-coding — is the through-line connecting every architecture in this deck.",["bigpicture","why"],1968),
(1,"Origins — Why 'neural' networks","One promising idea for learning was to loosely imitate the brain: many simple units ('neurons') wired together, adjusting their connections with experience.","Modelled on brain neurons","Biological inspiration gave neural networks their name and their basic design — simple units plus adjustable connections.",["bigpicture","why"],1943),
],
...
(3,"Transformers & LLMs — RAG vs Fine-Tuning (Applied)","The core decision: give the model documents at query time, or retrain it on your data.","RAG vs Fine-Tuning","Use RAG (retrieval) for fresh, factual, changing knowledge; fine-tune to change style/format or teach a narrow skill. Most production apps start with RAG because it's cheaper and instantly updatable.",["llm","rag","apply"],2023),
